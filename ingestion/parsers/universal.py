...
class UniversalParser :
    ...
    def _normalize_cell (value :object )->str :
        ...
        text =text .replace ("\n"," ").strip ()
        # Avoid breaking markdown table structure
        return text .replace ("|","\\|")
    ...
    # fast text parsing (strategy can be overridden by environment variables)
        elements =partition (
        filename =file_path ,
        ...
        for el in elements :
            ...
            # Compatible with non-PDF or fallback scenes
