...
state :Dict [str ,Any ],
    ...
    try :
        ...
        try :
            ...
            # Some models occasionally do not output JSON, but respond as text to avoid error reporting and interruption of the entire link.
