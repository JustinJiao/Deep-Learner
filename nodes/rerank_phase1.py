...
def rerank_phase1_node (state :AgentState )->AgentState :
    ...
    if multi_query_enabled and len (phase1_query_routes )>1 :
        ...
        # Only lightweight route data is retained for compose to ensure that each subquery has at least evidence to enter the prompt.
    ...
    # Release large fields to avoid repeated payment of deepcopy costs for subsequent nodes.
