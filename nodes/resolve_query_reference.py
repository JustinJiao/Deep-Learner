...
def resolve_query_reference_node (state :AgentState )->AgentState :
    ...
    # When there is a format problem such as JSON parsing failure, the main process will not be interrupted and the query will be returned directly to the original query.
