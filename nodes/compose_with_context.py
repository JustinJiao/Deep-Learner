...
def _normalize_citations_against_context(
    ...
    def _find_doc(citation: dict) -> dict | None:
        ...
        # LLM 常见错误：在真实 id 前附加序号，或只输出部分 id。
        ...
        if id_doc is not None:
            # 当 id 与 title 明显冲突时，优先用 title/quote 重新定位，避免引用错文档。
            if title:
